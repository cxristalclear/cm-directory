...
-- Seeds ISO 3166-1 country metadata

INSERT INTO public.countries (iso2, iso3, name)
SELECT country->>'alpha2' AS iso2,
       country->>'alpha3' AS iso3,
       country->>'name' AS name
FROM jsonb_array_elements(
$$[
  {"alpha2":"AF","alpha3":"AFG","name":"Afghanistan"},
  {"alpha2":"AX","alpha3":"ALA","name":"Aland Islands"},
  ...
  {"alpha2":"CI","alpha3":"CIV","name":"Cote d'Ivoire"},
  ...
  {"alpha2":"TR","alpha3":"TUR","name":"Turkiye"},
