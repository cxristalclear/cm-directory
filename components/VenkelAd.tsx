          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2.5">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-xs text-gray-600">Factory-Direct Components</span>
              </div>
              <p className="text-gray-700 mb-1.5 text-xs">
            ...
            <div className="flex-shrink-0">
              <Link
                ...
                className="inline-flex items-center gap-1.5 bg-orange-600 text-white px-3.5 py-1.5 rounded-md font-semibold hover:bg-orange-700 transition-colors text-xs"
              >
                Learn More
        ...
        <div className="p-3">
          ...
          <div className="space-y-1.5 mb-3 text-left">
            <div className="flex items-start gap-1.5 text-xs text-gray-700">
              <Package className="w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-orange-600" />
              <span>Free custom stocking programs</span>
            </div>
            <div className="flex items-start gap-1.5 text-xs text-gray-700">
              <TrendingUp className="w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-orange-600" />
              <span>Factory direct pricing</span>
            </div>
            <div className="flex items-start gap-1.5 text-xs text-gray-700">
              <Clock className="w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-orange-600" />
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer sponsored"
            className="inline-flex items-center justify-center gap-1.5 bg-orange-600 text-white px-3 py-1.5 rounded-md font-semibold hover:bg-orange-700 transition-colors w-full text-xs"
          >
            Learn More
