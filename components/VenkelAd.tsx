    ...
    return (
      <div className={`bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm ${className}`}>
        <div className="px-3 py-1.5 bg-gray-50 border-b border-gray-200">
          <span className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide">Sponsored</span>
        </div>
        <div className="p-4">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
            ...
            <div className="flex-shrink-0">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-orange-600 text-white px-5 py-2 rounded-lg font-semibold hover:bg-orange-700 transition-colors text-sm"
              >
                Learn More
      ...
      <div className={`bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm ${className}`}>
        ...
        <div className="p-4">
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer sponsored"
            className="inline-flex items-center justify-center gap-2 bg-orange-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-orange-700 transition-colors w-full text-sm"
          >
            Learn More
